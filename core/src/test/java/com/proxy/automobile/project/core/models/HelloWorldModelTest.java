 ...
 */
package com.proxy.automobile.project.core.models;
...
import com.proxy.automobile.project.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "proxyautomobileproject/components/helloworld");
